...
namespace Fall2024_FinalProject.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(User user)
        {
            ...
            Input = new InputModel
            {
                ...
                ProfilePhotoBase64 = user.ProfilePhoto != null ? Convert.ToBase64String(user.ProfilePhoto) : null
            };
        }
